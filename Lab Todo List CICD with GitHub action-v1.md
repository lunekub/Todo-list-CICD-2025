...
🐳 Docker Architecture
แยก Database กับ App คนละ Container: เพราะทำให้แก้ไข อัปเดต หรือสเกลแต่ละส่วนได้อิสระ และไม่กระทบกัน
Multi-stage Build: ลดขนาด image และทำให้ build เร็วขึ้น

🧪 Testing Strategy
Code Coverage: ช่วยวัดว่า test ครอบคลุมโค้ดแค่ไหน ยิ่งสูงยิ่งมั่นใจว่าโค้ดทำงานถูกต้อง

🚀 Deployment
Health Check Endpoint: ใช้ตรวจว่า service ยังทำงานปกติหรือไม่ หลัง deploy
Render vs Railway:
Render: เหมาะกับ production, เสถียรกว่า
Railway: เหมาะกับ dev หรือทดลอง ใช้ง่ายและเร็ว
